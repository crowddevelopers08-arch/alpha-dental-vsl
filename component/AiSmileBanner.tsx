...
export default function AiSmileBanner() {
  ...
  return (
    <section className="bg-[#f8f3f1] px-5 py-16 sm:px-8 lg:px-[60px] lg:py-20">
      <div className="relative mx-auto min-h-[302px] max-w-[1650px] overflow-hidden rounded-[28px] border border-brand-rose/25 bg-gradient-to-r from-brand-rose/45 via-brand-rose/20 to-brand-sage/10 shadow-[0_24px_60px_rgba(58,46,41,.08)] max-lg:min-h-0">
        <div className="relative z-20 flex min-h-[302px] w-full flex-col justify-center px-7 py-10 sm:px-[72px] lg:w-[56%] lg:px-[92px]">
          <p className="flex items-center gap-3 font-sans text-[13px] font-bold text-brand-rust max-sm:text-[11px]">
        ...
        <div className="relative h-[200px] overflow-hidden bg-brand-sage/15 lg:absolute lg:inset-y-0 lg:right-0 lg:h-auto lg:w-[40%]">
          <Image
          ...
          <div className="absolute bottom-10 left-3">
            <p className="mb-3 text-center text-[20px] font-semibold text-brand-rust">Before</p>
            <div className="relative h-[108px] w-[142px] overflow-hidden rounded-[15px] border-2 border-white shadow-sm">
              <Image src="https://res.cloudinary.com/x6ec5hqm/image/upload/v1786612791/smile-before.jpg" alt="Smile before treatment" fill className="object-cover" sizes="112px" />
            </div>
          </div>

          <div className="absolute right-3 bottom-10">
            <p className="mb-3 text-center text-[20px] font-semibold text-brand-rust">After</p>
            <div className="relative h-[108px] w-[142px] overflow-hidden rounded-[15px] border-2 border-white shadow-sm">
              <Image src="https://res.cloudinary.com/x6ec5hqm/image/upload/v1786612791/smile-promo.jpg" alt="Smile after treatment" fill className="object-cover" sizes="112px" />
            </div>
          </div>
        </div>
      </div>
