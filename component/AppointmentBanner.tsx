  ...
  return (
    <section id="book-appointment" aria-label="Book a dental appointment" className="relative overflow-hidden bg-[#f8f3f1] px-4 pb-10 pt-10 sm:px-6 xl:px-6 xl:pt-[130px]">
      <div className="relative mx-auto min-h-[298px] w-full max-w-[1684px] overflow-visible rounded-[26px] border border-brand-rose/60 bg-[#f8f3f1]">
        ...
        <Image
          src="https://res.cloudinary.com/x6ec5hqm/image/upload/v1787207239/den-im.png"
      ...
      <div className="relative mx-auto mt-5 block max-w-[420px] overflow-hidden rounded-[24px] bg-brand-rose max-sm:pt-0 pt-5 xl:hidden">
        <Image src="https://res.cloudinary.com/x6ec5hqm/image/upload/v1787207239/den-im.png" alt="Friendly dentist" width={1024} height={1536} quality={95} className="mx-auto h-[390px] w-full object-cover object-top" />
      </div>
    </section>
  );
}
