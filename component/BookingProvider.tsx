            ...
            {step === "schedule" ? (
              ...
              <form onSubmit={submit} className="p-5 sm:p-7">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <label className="text-sm font-semibold text-brand-ink">Location / Area<input required name="location" autoComplete="address-level2" className="mt-2 h-12 w-full rounded-xl border border-brand-rose/40 px-4 font-normal outline-none focus:border-brand-rust" /></label>
                  ...
                  <label className="text-sm font-semibold text-brand-ink">Preferred consultation<select required name="consultationType" defaultValue="" className="mt-2 h-12 w-full rounded-xl border border-brand-rose/40 bg-white px-4 font-normal outline-none focus:border-brand-rust"><option value="" disabled>Select option</option><option>Clinic Visit</option><option>Video Consultation</option></select></label>
                </div>
